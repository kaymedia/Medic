                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
							...
							<a href="<?php echo base_url("admin/daftar"); ?>"><button class="btn btn-primary ">Daftar Pasien Baru</button></a> <button data-toggle="modal" data-target="#cari" class="btn btn-primary">Cari Pasien</button>
