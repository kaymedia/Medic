...
class Admin extends CI_Controller {
	...
	public function tambah_satuanobat(){
		...
		$data = array ('satuanobat' => $satuanobat);
		$ekz = $this->master->tambah_data('tbl_satuanobat', $data);
		if($ekz){
			echo "
			<link href='".base_url()."/assets/sweetalert/sweetalert.css' rel='stylesheet' />
			<script src='".base_url()."/assets/bsb/plugins/jquery/jquery.min.js'></script>
			<script src='".base_url()."/assets/sweetalert/sweetalert.min.js'></script>
			 <script type='text/javascript'>
			  setTimeout(function () {  
			   swal({
				title: 'Berhasil Menyimpan',
				text: ' Satuan Obat ".$satuanobat." Berhasil Ditambahkan',
				type: 'success',
				timer: 4000,
				showConfirmButton: false
			   });  
			  ...
			  window.setTimeout(function(){ 
			  window.location.href='".base_url('/admin/msatuanobat/')."';	
			  } ,2100); 
			 </script>"; 
			//echo "<script>alert('Berhasil Menambah Data Obat.');window.location.href='".base_url('/admin/mobat')."' </script>";
		}
			...
			<script src='".base_url()."/assets/sweetalert/sweetalert.min.js'></script>
			 <script type='text/javascript'>
			  setTimeout(function () {  
			   swal({
				title: 'Gagal Menyimpan',
				text: 'Gagal Menambahkan Data Satuan Obat',
				type: 'error',
				timer: 4000,
				showConfirmButton: false
			   });  
	...
	public function edit_satuanobat($id_satuanobat)
	{
		if($id_satuanobat == ""){
			echo "<script>window.location.href='".base_url('/admin/msatuanobat')."' </script>";
		}
		$data['namaklinik'] = $this->namaklinik;
		$data['alamatklinik'] = $this->alamatklinik;
		$data['nohpklinik'] = $this->nohpklinik; 
		$data['judul'] = "Edit Satuan Obat - ".$this->namaklinik."";
		$data['nama'] = $this->session->userdata('nama'); 
		$data['username'] = $this->session->userdata('username'); 
		$this->load->view('/admin/header', $data);
		$data['v'] = $this->master->lihat_data('tbl_satuanobat', 'id_satuanobat', $id_satuanobat); 
		$this->load->view('/admin/edit_satuanobat', $data);
		$this->load->view('/admin/footer');
	}
	public function simpan_satuanobat($id_satuanobat)
	{
		if($id_satuanobat == ""){
			echo "<script>window.location.href='".base_url('/admin/msatuanobat')."' </script>";
		}
		$satuanobat = $this->input->post('satuanobat');
		$data = array ('satuanobat' => $satuanobat);
		$ekz = $this->master->simpan_data('tbl_satuanobat','id_satuanobat', $id_satuanobat, $data);
		if($ekz){
			echo "
			<link href='".base_url()."/assets/sweetalert/sweetalert.css' rel='stylesheet' />
			<script src='".base_url()."/assets/bsb/plugins/jquery/jquery.min.js'></script>
			<script src='".base_url()."/assets/sweetalert/sweetalert.min.js'></script>
			 <script type='text/javascript'>
			  setTimeout(function () {  
			   swal({
				title: 'Berhasil Menyimpan',
				text: 'Data Satuan Obat ".$satuanobat." Berhasil Dirubah',
				type: 'success',
				timer: 4000,
				showConfirmButton: false
			   });  
			...
			<script src='".base_url()."/assets/sweetalert/sweetalert.min.js'></script>
			 <script type='text/javascript'>
			  setTimeout(function () {  
			   swal({
				title: 'Gagal Menyimpan',
				text: 'Gagal Menyimpan Data Perubahan Satuan Obat',
				type: 'error',
				timer: 4000,
				showConfirmButton: false
			   });  
	...
	public function hapus_satuanobat($id_satuanobat){
		if($id_satuanobat == ""){
			echo "<script>window.location.href='".base_url('/admin/msatuanobat')."' </script>";
		}
		echo "
		...
		$this->master->hapus_obat($id_satuanobat);
		//redirect(base_url("/admin/mobat"));
	}
	//
	//suplier
	...
	public function mtindakan()
	{
		...
		$data['username'] = $this->session->userdata('username'); 
		$this->load->view('/admin/header', $data);
		$jumlahdata = $this->master->page_tindakan();
		$this->load->library('pagination');
		$config['base_url'] = base_url("admin/mtindakan/");
		$config['total_rows'] = $jumlahdata;
		$config['per_page'] = 10;
		$from = $this->uri->segment(3);
		// $config['page_query_string'] = TRUE;
		...
		$config['anchor_class'] = 'follow_link';
		$this->pagination->initialize($config);	
		$data['v'] = $this->master->data_tindakan($config['per_page'],$from);
		$data['jd'] = $jumlahdata;
		if($from < 1){
			$data['nomor'] = 1;
		}
		...
		$this->load->view('/admin/mtindakan', $data);
		$this->load->view('/admin/footer');
	}
	public function tambah_tindakan(){
		...
		$ekz = $this->master->tambah_data('tbl_tindakan', $data);
		if($ekz){
			echo "
			<link href='".base_url()."/assets/sweetalert/sweetalert.css' rel='stylesheet' />
			<script src='".base_url()."/assets/bsb/plugins/jquery/jquery.min.js'></script>
			<script src='".base_url()."/assets/sweetalert/sweetalert.min.js'></script>
			 <script type='text/javascript'>
			  setTimeout(function () {  
			   swal({
				title: 'Berhasil Menyimpan',
				text: 'Tindakan  ".$nama_tindakan." Berhasil Ditambahkan',
				type: 'success',
				timer: 4000,
				showConfirmButton: false
			   });  
			  ...
			  window.setTimeout(function(){ 
			  window.location.href='".base_url('/admin/mtindakan/')."';	
			  } ,2100); 
			 </script>"; 
			//echo "<script>alert('Berhasil Menambah Data Obat.');window.location.href='".base_url('/admin/mobat')."' </script>";
		}
			...
			<script src='".base_url()."/assets/sweetalert/sweetalert.min.js'></script>
			 <script type='text/javascript'>
			  setTimeout(function () {  
			   swal({
				title: 'Gagal Menyimpan',
				text: 'Gagal Menambahkan Data Tindakan',
				type: 'error',
				timer: 4000,
				showConfirmButton: false
			   });  
	...
	{
		if($id_tindakan == ""){
			echo "<script>window.location.href='".base_url('/admin/mtindakan')."' </script>";
		}
		$data['namaklinik'] = $this->namaklinik;
		$data['alamatklinik'] = $this->alamatklinik;
		$data['nohpklinik'] = $this->nohpklinik; 
		$data['judul'] = "Edit Tindakan - ".$this->namaklinik."";
		$data['nama'] = $this->session->userdata('nama'); 
		$data['username'] = $this->session->userdata('username'); 
		$this->load->view('/admin/header', $data);
		$data['v'] = $this->master->lihat_data('tbl_tindakan', 'id_tindakan', $id_tindakan); 
		$this->load->view('/admin/edit_tindakan', $data);
		$this->load->view('/admin/footer');
	}
	public function simpan_tindakan($id_tindakan)
	{
		if($id_tindakan == ""){
			echo "<script>window.location.href='".base_url('/admin/mtindakan')."' </script>";
		}
		...
		$ekz = $this->master->simpan_data('tbl_tindakan','id_tindakan', $id_tindakan, $data);
		if($ekz){
			echo "
			<link href='".base_url()."/assets/sweetalert/sweetalert.css' rel='stylesheet' />
			<script src='".base_url()."/assets/bsb/plugins/jquery/jquery.min.js'></script>
			<script src='".base_url()."/assets/sweetalert/sweetalert.min.js'></script>
			 <script type='text/javascript'>
			  setTimeout(function () {  
			   swal({
				title: 'Berhasil Menyimpan',
				text: 'Data Tindakan ".$nama_tindakan." Berhasil Dirubah',
				type: 'success',
				timer: 4000,
				showConfirmButton: false
			   });  
			...
			<script src='".base_url()."/assets/sweetalert/sweetalert.min.js'></script>
			 <script type='text/javascript'>
			  setTimeout(function () {  
			   swal({
				title: 'Gagal Menyimpan',
				text: 'Gagal Menyimpan Data Perubahan Tindakan',
				type: 'error',
				timer: 4000,
				showConfirmButton: false
			   });  
	...
	public function hapus_tindakan($id_tindakan){
			...
			<script src='".base_url()."/assets/sweetalert/sweetalert.min.js'></script>
			 <script type='text/javascript'>
			  setTimeout(function () {  
			   swal({
				title: 'Berhasil Menghapus',
				text: 'Data Tidakan Berhasil Dihapus',
				type: 'success',
				timer: 4000,
				showConfirmButton: false
			   });  
		...
		$this->master->hapus_data('tbl_tindakan', 'id_tindakan', $id_tindakan);
		//redirect(base_url("/admin/mobat"));
	}
	//
